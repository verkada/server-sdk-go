...
replace (
	github.com/livekit/server-sdk-go/v2 => github.com/verkada/server-sdk-go/v2 v2.9.2-jitter-buffer-fix
	github.com/livekit/server-sdk-go/v2/pkg/media => github.com/verkada/server-sdk-go/v2/pkg/media v2.9.2-jitter-buffer-fix 
)
